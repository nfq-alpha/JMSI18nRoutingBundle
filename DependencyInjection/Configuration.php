            ...
            ->root('jms_i18n_routing')
                ...
                ->children()
                    ...
                    ->scalarNode('strategy')
                        ->defaultValue('custom')
                        ->validate()
                            ->ifNotInArray(array('prefix', 'prefix_except_default', 'domains_prefix_except_default', 'custom'))
                            ->thenInvalid('Must be one of the following: prefix, prefix_except_default, domains_prefix_except_default, or custom (default)')
                        ->end()
                    ->end()
                        ...
                        ->prototype('array')
                            ->children()
                                ...
                                ->arrayNode('locales')
                                    ...
                                    ->prototype('scalar')->end()
                                ->end()
                                ->scalarNode('ga_code')->defaultNull('')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
